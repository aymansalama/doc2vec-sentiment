...
# print (model.docvecs["TRAIN_NEG_10"])
...
testing_arrays = numpy.zeros((1, 100))
testing_arrays[0] = model.infer_vector(new_vector)
...
for i in range(12500):
    ...
    #print (model.docvecs[prefix_train_pos])
...
#
#
inputS = "hate angry mad bad ugly"
#
s = inputS.rsplit()
s = model.infer_vector(s)

s_vector = numpy.zeros((1, 100))
s_vector[0] = s

print(clf.predict(s_vector))
